...
import { Inf131_notes } from "../../data/Inf131_notes.js";
	...
	onMount(() => {
		switch (page.toLowerCase()) {
			case 'cs162_notes1': headers=CS162_notes1; break;case 'cs165_prjct1': headers=CS165_prjct1; break;case 'testing': headers=Testing; break;case 'inf131_notes': headers=Inf131_notes; break;
			default:
				headers = [];
				break;
		}	
